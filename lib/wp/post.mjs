  ...
  return {
    ...
    async publishPair(article) {
      ...
      const koId = await createPost({
        ...
        categoryId: koCat, meta: { ...rankMath(article.bodyKo), [FP_META]: article.fingerprint }, featuredMedia: media,
      });
      ...
      const enId = await createPost({
        ...
        categoryId: enCat, meta: { ...rankMath(article.bodyEn), [FP_META]: article.fingerprint }, featuredMedia: media,
      });
